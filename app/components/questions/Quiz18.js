...
export default function Quiz18(props) {
  const { Data } = props;
  const data = [
    {
      label: 'Nunca', value: 0
  ...
  return (
    <View style={styles.view}>
      <View style={styles.viewTitle}>
        ...
        <View style={styles.viewQuiz}>
          <Text style={styles.textQuiz}>
            Estoy demasiado fatigado/a o cansado/a para mantener el estilo de vida que solía llevar?
                  </Text>
        </View>
      </View>
      <View style={styles.viewQuestions}>
        <RadioButtonRN
          data={data}
          selectedBtn={(e) => Data.pregunta18 = (e.value)}
